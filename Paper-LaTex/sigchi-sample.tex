...
Our results include game control taxonomies, user-defined game control sets, user rating, subjective responses, and qualitative observations for each interaction method.
  ...
  \subsection{Behavior with Different Forms of Glasses}
    ...
    \begin{tabular}{|l|l|l|}
      ...
      \Xhline{4\arrayrulewidth}
        ...
        \textbf{\em{{\fontsize{0.3cm}{1em}\selectfont (On-Body)}}} & \em{fingers} & I.b. fingers.\\ \cline{2-3} 
             & \em{leg} & I.b. hand and leg.\\ \cline{2-3} 
             ...
             & \em{ring} & Interaction with ring. \\ \cline{2-3} 
             & \em{watch} & Interaction with watch.\\ \cline{2-3} 
             & \em{glasses} & Interaction with glasses.\\ \cline{2-3} 
             & \em{necklace} & Interaction with necklace.\\ 
      \Xhline{4\arrayrulewidth}
...
The \emph{Form} dimension for \emph{In-Air} input and the the \emph{Form} dimension for \emph{On-Body} input are both dominated with hand related input. We found that the forms of \emph{On-Body} controls are more complicated than those of \emph{In-Air}. Nonetheless, the binding of \emph{On-Body} is more consistent. About 75\% of the controls are independent of the screen. In addition, we were surprised that no user designed a \emph{direct-binding} or \emph{physical} control with \emph{On-Body} input. And we were also surprised to find that for the \emph{Flow} dimension, the percentage distribution is similar for In-Air and On-Body interaction.
