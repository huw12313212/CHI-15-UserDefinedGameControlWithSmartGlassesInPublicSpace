...
%    \subsubsection{Identical Gestures for Different Surface.}
 ...
 \begin{figure}[!h]
  ...
  In our study, we only asked participants to experience two types of Smart Glasses, so our user-defined game control set may not be appropiate for applying to games on all types of Smart Glasses. Moreover, our participants were all literate Taiwanese adults; undoubtedly, childern, elders, Westerners, or uneducated participants would behave differently. These issues are worthy of investigation, but are beyond the range of current work.
