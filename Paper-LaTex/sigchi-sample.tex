...
Our results include game control taxonomies, user-defined gesture sets, user rating, subjective responses, and qualitative observations for each interaction methods.
  ...
  The authors manually classified each gesture along four dimensions: \emph{form}, \emph{nature}, \emph{binding}, and \emph{flow}. Within each dimension are multiple categories, shown in Table \ref{tab:taxonomy}.
   ...
   \begin{table}
    ...
    \begin{tabular}{|l|l|l|}
      ...
      \hline
        \textbf{\em{Form}} & \em{finger} & Using finger to perform control.\\
        \textbf{\em{(In-Air)}}  & \em{hand} & Using hand to perform control.\\
             & \em{head} & Using head to perform control.\\
             & \em{voice} & Using voice control.\\
      \hline
     % \hline
        \textbf{\em{Form}} & \em{palm} & Interact b.t. finger and palm. \\
        \textbf{\em{(On-Body)}} & \em{fingers} & Interact b.t. fingers.\\

             & \em{leg} & Interact b.t. hand and leg.\\
             & \em{handback} & Interact b.t. finger and handback.\\
             & \em{forearm} & Interact b.t. finger and forearm.\\
             & \em{face} & Interact b.t. finger and face.\\
             & \em{wrist} & Interact b.t. finger and wrist.\\
             & \em{ring} & Interact with ring. \\
             & \em{watch} & Interact with watch.\\
             & \em{glasses} & Interact with glasses.\\
             & \em{necklace} & Interact with necklace.\\
      \hline
      %\hline
        \textbf{\em{Binding}} & \em{direct} & Directly control with screen. \\
             & \em{surface} & Absolute mapping screen to surface.\\
             & \em{independent} & No binding b.t. screen and control.\\
      \hline
      %\hline
        \textbf{\em{Nature}} & \em{symbolic} & Control visually depicts a symbol.\\
             & \em{physical} & Control acts physically on objects.\\
             & \em{metaphorical} & Control indicates a metaphor.\\
             & \em{abstract} & Control mapping is arbitrary.\\
      \hline
      %\hline
        \textbf{\em{Flow}} & \em{discrete} & Response occurs \em{after} the user acts.\\
  ...
  \end{table}
   ...
   To control for interrater effects, an independent rater performed the same categorization using 170 trials data (random selected 10 trials for each tasks), Interrater reliability shown in table \ref{tab:kappa}. The average Kappa is .897. A Kappa value of .8 and higher is considered \textsl{almost perfect}.
