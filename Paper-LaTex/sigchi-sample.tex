...
\section{Related Work}
    ...
    User-elicitation studies are a specific type of participatory design methodology that involves end-users in the design of control-sets \cite{Morris:2012:WWI:2396636.2396651}.
...
\section{Conclusion}
We have presented a study of glass game control leading to a user-defined game control set based on participants' agreement over 2448 gestures. It can appropriately reflect the user gaming behavior in public space with in-air and on-body inputs. We also have presented a taxonomy of glass game controls useful for analyzing and characterizing control actions with smart glasses. In capturing game controls for this study, we have gained insight into the mental models of public users and have tranlated these into implications for techonoloy and design. This work represents a necessary step in bringing smart glass gaming closer to the hands and minds of public people.
