 ...
 \begin{table}
    ...
    \begin{tabular}{|l|l|l|}
     ...
     % \hline
        ...
        \textbf{\em{(On-Body)}} & \em{finger} & Interact b.t. fingers.\\
      ...
      \hline
    \end{tabular}
    \caption{Taxonomy of game controls based on 2448 gestures. The abbreviation ``w.r.t.'' means ``with respect to'' and ``b.t.'' means ``between''.}
    \label{tab:taxonomy}
  \end{table}
