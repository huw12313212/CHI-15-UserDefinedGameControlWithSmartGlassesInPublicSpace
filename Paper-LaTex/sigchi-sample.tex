...
%需要描述場域嘛？
  ...
  \caption{Summary of users' game control familiarity.}
...
Our results include game control taxonomies, the user-defined gesture sets, user rating, subjective responses, and qualitative observations for each interaction methods.
 ...
 \begin{figure}[!h]
  ...
  \caption{The top 6 on-body input forms. (A)Interact between finger and palm. (B)Interact with ring. (C)Interact between fingers. (D)Interact betwwen finger and hand back. (E)Interact with watch. (F)Interact with necklace. }
  \label{fig:figureFamiliarity}
  \end{figure}   
